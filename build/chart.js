...
(function() {
  var firebaseRef, svg, svgH, svgH2, svgW, svgW2, svgl, svgr, updateMFChart, updatePyramid, xMargin, yMargin;
  ...
  svgl = d3.select("body").append("svg").attr("width", svgW2).attr("height", svgH2);

  svgr = d3.select("body").append("svg").attr("width", svgW2).attr("height", svgH2).style('margin-left', 20);
